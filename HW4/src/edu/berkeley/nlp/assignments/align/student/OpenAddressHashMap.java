...
//        capacity = PrimeFinder.nextPrime(capacity);
        ...
        this.counter = new double[capacity];
    ...
    public double getValue(int key1, int key2) {
...
//        dataSize = PrimeFinder.nextPrime(dataSize);
        ...
        double[] newCounter = new double[dataSize];
        double[] newKeys = new double[dataSize];
